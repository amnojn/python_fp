...
def save_document(docs, file_name, doc):
    # Pure: tidak mengubah dictionary asli
...
def add_line_break(line):
    # Pure: tidak melakukan print (side effect)
    # cukup mengembalikan string baru yang sudah diberi line break
    return line + "\n\n"
