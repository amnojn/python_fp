def word_count_memo(document, memos):
    ...
    # Step 2: jika sudah ada di memos, langsung return
    if document in updated_memos:
        return updated_memos[document], updated_memos
    
    # Step 3: hitung word count menggunakan fungsi word_count
    count = word_count(document)
    
    # Step 4: simpan hasil ke updated_memos
    updated_memos[document] = count
    
    # Step 5: return count dan updated memos
    return count, updated_memos
