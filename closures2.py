def new_collection(initial_docs):
    docs = initial_docs.copy()   # membuat salinan, agar tidak mengubah list asli

    def add_doc(new_doc):
        docs.append(new_doc)     # menambah dokumen baru
        return docs              # mengembalikan list yang sudah diperbarui
